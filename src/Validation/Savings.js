...
const useFormValidationSchema = () => {
    ...
    useEffect(() => {
        const individualValidationSchema = Yup.object().shape({
            ...
            acc02salutation: Yup.string().required("Salutation is required"),
            acc02is_local_citizen: Yup.boolean().required("Local Citizen status is required"),
            ...
            acc02phone_no: Yup.number().required("Phone Number is required").min(1, "Phone Number is required"),
            ...
            acc02contact_medium_no: Yup.string().required("Contact Medium Number is required"),
        });
