          ...
          <div className="row justify-content-center mt-4">
            ...
            <div className="col-md-3 p-0 col-lg-3 col-sm-3 col-xl-2 mx-auto mt-3">
              ...
              <ul className="footer-link p-0">
                ...
                <li className="nav-link">
                  <a href="#" className="text-uppercase"> csr </a>
                </li>
              </ul>
            </div>
          </div>
                ...
                <div className="d-flex align-items-start col-md-4 col-lg-3 col-xl-3 justify-content-lg-end mx-0 contact pt-2">
                  ...
                  <div className="d-flex ms-3 social-icon">
                    <li className="nav-link px-2">
                      <a href="https://www.facebook.com/mahalaxmibikasbank/" target="_blank">
                      <i class="bi bi-facebook fa-2x"></i>
                      </a>
                    </li>
                    <li className="nav-link px-2">
                      <a href="https://twitter.com/bank_bikas?lang=en" target="_blank">
                      <i class="bi bi-twitter fa-2x"></i>
                      </a>
                    </li>
                    <li className="nav-link px-2">
                      <a href="https://www.youtube.com/watch?v=5h57KaIbLWs" target="_blank">
